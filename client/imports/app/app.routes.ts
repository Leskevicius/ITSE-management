...
import { AdminTeamBidsComponent } from './home/admin/admin-team-bids.component';
...
export const routes: Route[] = [
  ...
  { path: 'admin/teamBids', component: AdminTeamBidsComponent, canActivate: ['canActivateForAdmin']},
